...
local input_data, error = ckb.load_all_cell_data(ckb.SOURCE_INPUT)
assert(type(input_data) == "table")
print(#input_data)
assert(gettablelength(input_data) == 1)
assert(input_data[1] == "\x61\x62\x63")
